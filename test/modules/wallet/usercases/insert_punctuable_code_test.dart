...
void main() {
  ...
  final InsertPunctuableCode insertPunctuableCode = InsertPunctuableCodeImpl(
      repositoryMock, findEstablismentByIdMock, getLoggedUserTokenMock);
  group('InsertPunctuableCode', () {
    test('Deve inserir um codigo pontuavel', () async {
      ...
      when(
        () => repositoryMock.validadePunctuableCode(
      ...
      var response = await insertPunctuableCode(
        code: '123',
      );
