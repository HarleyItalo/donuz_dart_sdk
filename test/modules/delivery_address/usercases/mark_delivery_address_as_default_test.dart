...
void main() {
  ...
  var markDeliveryAddressAsDefault = MarkDeliveryAddressAsDefaultImpl(
    repository,
  ...
  group("markDeliveryAddressAsDefault", () {
    test("Deve marcar um endereco de entrega como padrao", () async {
      when(
      ...
      when(
        () => repository.setAddressAsDefault(
          addressId: 1234,
          userId: 1234,
          appId: '2234',
          tokenClient: '123',
      ...
      var response = await markDeliveryAddressAsDefault(addressId: 1234);
