...
void main() {
  ...
  var getAllDeliveryAddress = GetAllDeliveryAddressImpl(
    repository,
  ...
  group("GetAllDeliveryAddress", () {
    test("Deve buscar os enderecos de entrega", () async {
      when(
      ...
      when(
        () => repository.getAllAddress(
            userId: 1234, appId: '2234', tokenClient: '123'),
      ).thenAnswer(
      ...
      var response = await getAllDeliveryAddress();
